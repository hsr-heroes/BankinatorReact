    ...
    render() {
        ...
        return (
                ...
                <Form className='attached fluid segment'>
                    <Form.Field>
                        <Dropdown placeholder='Nach Jahr Filtern' onChange={this.onChangeYear} value={this.state.year} selection options={this.allYears} />
                    </Form.Field>
                    <Form.Field>
                        <Dropdown placeholder='Nach Monat Filtern' onChange={this.onChangeMonth} value={this.state.month} selection options={this.allMonth} />
                    </Form.Field>
                </Form>
            </Container>
        )
